...
<div class="prd-block">
    ...
    ?>
    	<div class="prd-img"><img width="80%" src="quantri/anh/<?php echo $row['anh_sp'] ?>" /></div>	
        

        <div class="prd-intro">
        	<h3><p><?php echo $row['ten_sp'] ?><P></h3>
            ...
            <p class="add-cart"><a href="chucnang/giohang/themhang.php?id_sp=<?php echo $row['id_sp'] ?>"><span><font color="00ff00"> đặt mua</font></span></a></p>
        </div>
