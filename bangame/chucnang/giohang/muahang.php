...
<div class="prd-block">
    ...
    <div class="payment">
    	<table border="0px" cellpadding="0px" cellspacing="0px" width="100%">
            ...
            <tr>
                ...
                <td class="prd-total"><?php echo $totalPrice ?>.000 VNĐ</td>
            </tr>
             <?php
            ...
            <tr>
                ...
                <td colspan="2"></td>
                <td class="prd-total"><span><?php echo $totalPriceAll ?>.000 VNĐ</span></td>
            </tr>
        </table>
    ...
    <div class="form-payment">
    	<form method="post">
    	<ul>
        	<li class="info-cus"><label>Tên khách hàng</label><br /><input required type="text" name="name" /></li>
            <li class="info-cus"><label>Địa chỉ Email</label><br /><input required type="text" name="mail" /></li>
            <li class="info-cus"><label>Số Điện thoại</label><br /><input required type="text" name="mobi" /></li>
            <li class="info-cus"><label>Địa chỉ nhận hàng</label><br /><input required type="text" name="add" /></li>
            <li><input type="submit" name="submit" value="Mua hàng" /> <input type="reset" name="reset" value="Làm lại" /></li>
        </ul>
        </form>
    </div>
</div>
...
if(isset($_POST['submit'])){
        ...
        $sdt=$_POST['mobi'];
        $diachi=$_POST['add'];
    if(isset($ten) && isset($mail) && isset($sdt) && isset($diachi)){
    ...
    // Phải chỉnh sửa lại
    $mailer->Username = "khoadanglenguyen2000@gmail.com"; // GMAIL username
    $mailer->Password = "04182015"; // GMAIL password
    $mailer->AddAddress($mail, $ten); //email người nhận
    $mailer->AddCC("khoadanglenguyen2000@gmail.com", "Admin K3mart"); // gửi thêm một email cho Admin
    // Chuẩn bị gửi thư nào
    $mailer->FromName = 'K3mart'; // tên người gửi
    $mailer->From = 'khoadanglenguyen2000@gmail.com'; // mail người gửi
    $mailer->Subject = 'Hóa đơn xác nhận mua hàng từ K3mart';
