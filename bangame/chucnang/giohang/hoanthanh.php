...
<title>K3mart- Mua hàng thành công</title>
...
<div id="wrapper">
    ...
    <div id="header">
        ...
        <div id="main-bar">
        	<div id="logo"><a href="#"><img src="anh/logo05.png" /></a></div>
            <div id="banner"></div>
        </div>
        <div id="navbar">
        	<ul>
    ...
    <div id="body">
    	...
    	<div id="l-col">
            ...
            <div class="l-sidebar">
            	<h2>Game Hot</h2>
            	<div class="l-banner"><a href="#"><img width="216" src="anh/banner02.png" /></a></div>
            </div>
            <div class="l-sidebar">
            	<h2>thống kê truy cập</h2>
                <div id="counter">
                	<p>Hiện có <span>100</span> người đang xem</p>
                </div>
    ...
    <div id="footer">
    	<div id="footer-info">
        	<h4>K3mart</h4>
            <p><span>Địa chỉ:</span> Đà Lạt-Lâm Đồng | <span>Phone</span> (04) 3537 6697</p>
            <p> <span>Hotline</span> 012345678</p>
            <p>Shop game PS4</p>
        </div>
    </div>
    <!-- End Footer -->
