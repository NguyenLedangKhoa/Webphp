...
<div class="prd-block">
    ...
    ?>
    	<table width="100%">
        	<tr>
            	<td class="cart-item-img" width="25%" rowspan="4"><img width="135" height="150" src="quantri/anh/<?php echo $row['anh_sp'] ?>" /></td>
            ...
            <tr>
            	<td>Tổng tiền:</td>
                <td><span><?php echo $totalPrice ?>.000 VNĐ</span></td>
            </tr>
        </table>
    <?php
    ...
    ?>
        ...
        <p>Tổng giá trị giỏ hàng là: <span><?php echo $totalPriceAll ?>.000 VNĐ</span></p>
        <p class="update-cart"><a href="#" onclick="document.getElementById('giohang').submit();"><span><font color="00ff00">cập nhật giỏ hàng</font></span></a></p>
