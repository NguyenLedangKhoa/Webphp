...
<div id="main">
	...
	<table id="add-prd" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
        	<td><label>Giá sản phẩm</label><br /><input type="text" name="gia_sp" value="<?php if(isset($_POST['gia_sp'])){echo $_POST['gia_sp'];}else{echo $arr['gia_sp'];}?>" /></td><?php if(isset($error_gia_sp)){echo $error_gia_sp;}?></td>
        </tr>
        <tr>
        ...
        <tr>
        	<td><label>Thông tin chi tiết sản phẩm</label><br /><textarea cols="60" rows="12" name="chi_tiet_sp"><?php if(isset($_POST['chi_tiet_sp'])){echo $_POST['chi_tiet_sp'];}else{echo $arr['chi_tiet_sp'];}?></textarea><?php if(isset($error_chi_tiet_sp)){echo $error_chi_tiet_sp;}?></td>
        </tr>
        <tr>
