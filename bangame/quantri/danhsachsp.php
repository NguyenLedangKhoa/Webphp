...
<div id="main">
	<p id="add-prd"><a href="quantri.php?page_layout=themsp"><span><font color="00ff00"> thêm sản phẩm mới</font></span></a></p>
	<table id="prds" border="0" cellpadding="0" cellspacing="0" width="100%">
    	<tr id="prd-bar">
            <td width="5%">ID</td>
            <td width="40%">Tên sản phẩm</td>
            <td width="15%">Giá</td>
            <td width="20%">Thể loại</td>
        ...
        <tr>
            ...
            <td><span class="thumb"><img width="95px" height="125px" src="anh/<?php echo $row['anh_sp'];?>" /></span></td>
