...
<div id="main">
	...
	<table id="add-prd" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
        	<td><label>Thể loại game</label><br />
            	<select name="id_dm">
                	<option value="unselect" selected="selected">Lựa chọn thể loại</option>
                    <option value=1>Bắn súng</option>
                    <option value=2>Hành động</option>
                    <option value=3>Nhập vai</option>
                    <option value=4>Phiêu lưu</option>
                    <option value=5>Đua xe</option>
                    <option value=6>Thể thao</option>
                    <option value=7>Đối kháng</option>
                </select>
        ...
        <tr>
        	<td><label>Bảo hành</label><br /><input type="text" name="bao_hanh" value="1 Tháng" /><?php if(isset($error_bao_hanh)){echo $error_bao_hanh;}?></td>
        </tr>
        <tr>
        	<td><label>Đi kèm</label><br /><input type="text" name="phu_kien" value="CD,Box" /><?php if(isset($error_phu_kien)){echo $error_phu_kien;}?></td>
        </tr>
        <tr>
        	<td><label>Tình trạng</label><br /><input type="text" name="tinh_trang" value=" Mới 100%" /><?php if(isset($error_tinh_trang)){echo $error_tinh_trang;}?></td>
        </tr>
        <tr>
        	<td><label>Khuyến mại</label><br /><input type="text" name="khuyen_mai" value="Tay cầm" /><?php if(isset($error_khuyen_mai)){echo $error_khuyen_mai;}?></td>
        </tr>
        <tr>
